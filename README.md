...
El sistema permite alternar dinámicamente entre el inicio de sesión y el registro de nuevos usuarios, validando las credenciales contra el almacenamiento local.

| Inicio de Sesión | Registro de Cuenta |
| :---: | :---: |
| ![Login](img/img_inicioSession.png) | ![Registro](img/img_crearCuenta.png) |
| *Acceso mediante correo institucional.* | *Creación de perfil de estudiante.* |

### 7.2 Dashboard y Gestión de Tareas
El núcleo de la plataforma permite un control total sobre las actividades académicas con filtros dinámicos y estadísticas en tiempo real.

| Panel de Tareas General | Filtros de Prioridad y Estado |
| :---: | :---: |
| ![Tareas](img/img_tareas.png) | ![Filtros](img/img_notificacionTarea.png) |
| *Vista general con barra de búsqueda y stats.* | *Sistema de notificaciones y filtrado avanzado.* |

**Creación de Tareas:**
El proceso de registro de tareas utiliza un modal interactivo que permite categorizar por curso y nivel de urgencia.

| Formulario de Registro | Confirmación de Acción |
| :---: | :---: |
| ![Nueva Tarea](img/img_agregarTarea.png) | ![Tarea Guardada](img/img_tareaAgregada.png) |
| *Configuración de fecha límite y curso.* | *Feedback visual al usuario tras guardar.* |

### 7.3 Comunicación y Perfil
Interfaz de mensajería simulada para coordinación grupal y un panel de perfil personalizado.

|             Centro de Mensajes             |             Perfil del Estudiante             |
| :----------------------------------------: | :-------------------------------------------: |
|       ![Chat](img/img_mensajes.png)        |         ![Perfil](img/img_inicio.png)         |
| *Simulación de chat con estados en línea.* | *Panel de bienvenida y objetivos personales.* |

### 7.4 Información del Proyecto y Stack Tecnológico
Detalle de los objetivos alcanzados y las herramientas profesionales utilizadas durante el desarrollo.

| Objetivos y Herramientas | Resumen del Equipo |
| :---: | :---: |
| ![Stack](img/imc_acerca2.png) | ![Acerca](img/img_acerca.png) |
| *Visualización del MVP y stack técnico.* | *Metodología ágil y enfoque UX.* |
